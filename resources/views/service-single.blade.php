        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Construcción de Inmuebles</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="services.html">Servicios</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Construcción de Inmuebles</li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="service-single.html">Construcción de Inmuebles</a></li>
              <li><a href="service-single.html">Remodelaciones</a></li>
              <li><a href="#">Diseño Interior</a></li>
              <li><a href="#">Diseño Exterior</a></li>
              <li><a href="#">Renovación</a></li>
              <li><a href="#">Gestión de Seguridad</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">El arte de la construcción</h2>
          ...
          <div class="row">
            <div class="col-md-6">
              <h3 class="column-title-small">Qué hacemos diferente</h3>
            ...
            <div class="col-md-6 mt-5 mt-md-0">
              <h3 class="column-title-small">Deberias conocer</h3>
            ...
            <div class="row align-items-center">
              <div class="col-md-8 text-center text-md-left">
                <div class="call-to-action-text">
                  <h3 class="action-title">Estás interesado en este servicio</h3>
                </div>
              </div><!-- Col end -->
              <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                <div class="call-to-action-btn">
                  <a class="btn btn-primary" href="contact.html">Solicita una Cotización</a>
                </div>
              </div><!-- col end -->
            </div><!-- row end -->
          </div><!-- Action end -->
