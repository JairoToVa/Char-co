...
<section id="main-container" class="main-container">
  <div class="container">
    <div class="row">
        <div class="col-lg-6">
          <h3 class="column-title">Quienes Somos</h3>
          <p>Somos una empresa 100% mexicana dedicada al diseño arquitectónico y construcción de inmbuebles, que cuenta con una experiencia de 17 años en esta rama.</p>
          <blockquote><p>El esfuerzo que hemos realizado es para mantener la calidad de nuestros servicios para que nuestros clientes queden satisfechos con los proyectos y trabajos que realizamos</p></blockquote>
          <p>Nuestro equipo de trabajo cuenta con la experiencia y se encuentra capacitado para sobrellevar cada uno de los proyectos.</p>
  ...
  <div class="container">
    <div class="row text-center">
        <div class="col-lg-12">
          ...
          <h3 class="section-sub-title">Equipo Profesional</h3>
        </div>
    </div><!--/ Title row end -->
